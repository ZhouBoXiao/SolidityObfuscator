from solidityobf.common.classes import Ident, Number, List, Ltrue, Lfalse, String, Expr, Assignment,Function,Program,Statements,VarDeclaration
from solidityobf.common.common import *
from solidityobf.common.tree_walker import walker
from solidityobf.transformations.common import NUMBERMAX, count_object, shouldi, gen_dummy_expr, pick_one
...
def add_dummy_exprs_func(parse_tree, arg):
    if parse_tree.__class__ in [Function, Statements]:
    ...
    if parse_tree.__class__ == Statements:
        if shouldi(arg=arg):
            ...
            parse_tree.insert(solidityobf_random.randint(0, len(parse_tree.statements_list)), expr)
    return [], arg
